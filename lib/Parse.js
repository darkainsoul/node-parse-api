...
Parse.prototype = {
    ...
    insert: function (className, object, callback) {
        parseRequest.call(this, 'POST', '/parse/classes/' + className, object, callback);
    },

    // add files
    insertFile: function(fileName, data, contentType, callback){
        parseRequest.call(this, 'POST', '/parse/files/' + fileName, data, callback, contentType);
    },

    // create a new user
    insertUser: function (data, callback) {
        parseRequest.call(this, 'POST', '/parse/users/', data, callback);
    },

    findWithObjectId: function (className, objectId, callback){
        var url = '/parse/' + (className === '_User' ? 'users' : 'classes/' + className + '/' + objectId);
    ...
    find: function (className, query, callback) {
        var url = '/parse/' + (className === '_User' ? 'users' : 'classes/' + className);
  ...
  findCloudFunction: function (functionName, data, callback) {
    parseRequest.call(this, 'POST', '/parse/functions/' + functionName, data, callback);
  },
  ...
  // get a collection of objects
    ...
    batch: function (requests,callback) {
        parseRequest.call(this,'POST','/parse/batch',{requests:requests},callback);
    },

    // user login
    loginUser: function (username, password, callback) {
        parseRequest.call(this, 'GET', '/parse/login/?username=' + username + '&password=' + password, null, callback);
    },

    // user logout
    logoutUser: function (sessionToken, callback) {
        parseRequest.call(this, 'POST', '/parse/logout', null, callback, null, sessionToken);
    },

    // retrieve current user
    me: function (sessionToken, callback) {
        parseRequest.call(this, 'GET', '/parse/users/me', null, callback, null, sessionToken);
    },
    ...
    findFileByUser: function(userId, className, callback) {
        ...
        parseRequest.call(this, 'GET', '/parse/classes/' + className + '?' + encodedString, null, callback);
    },
    ...
    insertCustom: function (className, object, callback) {
        parseRequest.call(this, 'POST', '/parse/' + className, object, callback);
    },

    // update an object in the class store
    update: function (className, objectId, object, callback) {
        parseRequest.call(this, 'PUT', '/parse/classes/' + className + '/' + objectId, object, callback);
    },
    ...
    updateUserEmail: function(objectId, data, sessionToken, callback) {
        ...
        data = { email: data };
        parseRequest.call(this, 'PUT', '/parse/users/' + objectId, data, callback, null, sessionToken);
    },
    ...
    passwordReset: function (data, callback) {
        data = { email: data };
        parseRequest.call(this, 'POST', '/parse/requestPasswordReset/', data, callback);
    },

    // remove an object from the class store
    delete: function (className, objectId, callback) {
        parseRequest.call(this, 'DELETE', '/parse/classes/' + className + '/' + objectId, null, callback);
    },
    ...
    deleteUser: function (objectId, sessionToken, callback) {
        ...
        parseRequest.call(this, 'DELETE', '/parse/users/' + objectId, null, callback, null, sessionToken);
    },
    ...
    insertInstallationData: function (deviceType, deviceToken, callback) {
        ...
        parseRequest.call(this, 'POST', '/parse/installations/', data, callback);
    },
    ...
    updateInstallationDataChannels: function(objectId, channels, callback) {
        parseRequest.call(this, 'PUT', '/parse/installations/' + objectId, {
            channels: channels
        }, callback);
    },

    getInstallationData: function(callback) {
        parseRequest.call(this, 'GET', '/parse/installations', null, callback);
    },

    getInstallationDataForDeviceToken: function(deviceToken, callback) {
        parseRequest.call(this, 'GET', '/parse/installations?where={"deviceToken":"'+deviceToken+'"}', null, callback);
    },

    deleteInstallation: function(objectId, callback) {
      parseRequest.call(this, 'DELETE', '/parse/installations/' + objectId, null, callback);
    },
    ...
    countObjects: function (className, query, callback) {
        if (typeof(query) === "function") {
            parseRequest.call(this, 'GET', '/parse/classes/' + className, null, query);
        }
        if (typeof(query) === "string") {
            parseRequest.call(this, 'GET', '/parse/classes/' + className + '/' + query, null, callback);
        } else {
            parseRequest.call(this, 'GET', '/parse/classes/' + className, { where: JSON.stringify(query) }, callback);
        }
    },
    ...
    addRelation: function( relationName, className1, objectId1, className2, objectId2, callback) {
        ...
        parseRequest.call(this,'PUT','/parse/classes/' + className1+'/'+objectId1,data,callback);
    },
    ...
    insertRole: function (data, callback) {
        parseRequest.call(this, 'POST', '/parse/roles/', data, callback);
    },

    getRole: function (objectId, callback) {
        parseRequest.call(this, 'GET', '/parse/roles/' + objectId, null, callback);
    },

    getRoles: function (params, callback) {
        if (typeof(params) === "function") {
            parseRequest.call(this, 'GET', '/parse/roles/', null, params);
        }
        if (typeof(params) === "string") {
            parseRequest.call(this, 'GET', '/parse/roles/' + params, null, callback);
        } else {
            params = JSON.stringify(params);
            parseRequest.call(this, 'GET', '/parse/roles/', params, callback);
        }
    },

    updateRole: function (objectId, data, callback) {
        parseRequest.call(this, 'PUT', '/parse/roles/' + objectId, data, callback);
    },

    deleteRole: function (objectId, callback) {
        parseRequest.call(this, 'DELETE', '/parse/roles/' + objectId, callback);
    },

    sendPush: function (data, callback) {
        parseRequest.call(this, 'POST', '/parse/push/', data, callback);
    },

    getCurrentSession: function(objectId, callback)
    {
      parseRequest.call(this, 'GET', '/parse/sessions/'+ objectId, callback);
    }
...
function toDeleteOps(className, objects){
    return objects.map(function(object){
        return {
            method: 'DELETE',
            path: '/parse/' + ( className === '_User' ? 'users/' : 'classes/' + className + '/' ) + object.objectId
        };
    });
}
